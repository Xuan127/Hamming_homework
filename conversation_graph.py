...
class ConversationGraph:
    ...
    def visualize_graph(self):
        ...
        nx.draw_networkx_labels(self.graph, label_pos, font_size=10, font_weight='bold')
        nx.draw_networkx_edge_labels(self.graph, pos, edge_labels=conditions, font_color='red')
